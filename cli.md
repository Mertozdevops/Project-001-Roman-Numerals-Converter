...
```bash
aws ec2 describe-security-groups --group-names rafe-roman_numbers_sec_grp
```
...
aws ec2 run-instances \
    ...
    --key-name rafe-lesson \
    --security-group-ids sg-0edce99cb8353eb62 \
    --tag-specifications 'ResourceType=instance,Tags=[{Key=Name,Value=rafe-roman_numbers}]' \
